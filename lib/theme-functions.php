...
function modify_footer_admin () {
	echo 'Creado por <a href="jburbano.com">Jairo Burbano</a>. Potenciado por <a href="http://www.wordpress.org">WordPress</a>';
}
/**
...
function ss_url_login(){
	return 'jburbano.com'; // The root of your site or any relative link
}
function ss_url_title(){
	return 'Jairo Burbano'; // The title of your link
}
